...
#define PERIPHERAL_BATTERY_REFRESH_MS 5000
...
static void refresh_peripheral_batteries(lv_timer_t *timer) {
    ARG_UNUSED(timer);
...
#if IS_ENABLED(CONFIG_ZMK_SPLIT_BLE_CENTRAL_BATTERY_LEVEL_FETCHING)
    refresh_peripheral_batteries(NULL);
    lv_timer_create(refresh_peripheral_batteries, PERIPHERAL_BATTERY_REFRESH_MS, NULL);
#endif
